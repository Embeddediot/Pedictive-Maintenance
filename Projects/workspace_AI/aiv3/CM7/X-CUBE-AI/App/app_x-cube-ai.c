...
static const ai_network_entry_t networks[AI_MNETWORK_NUMBER] = {
    ...
    {
        .name = (const char *)AI_SINE_MODEL_MODEL_NAME,
        .config = AI_SINE_MODEL_DATA_CONFIG,
        .ai_get_report = ai_sine_model_get_report,
        .ai_create = ai_sine_model_create,
        .ai_destroy = ai_sine_model_destroy,
        .ai_get_error = ai_sine_model_get_error,
        .ai_init = ai_sine_model_init,
        .ai_run = ai_sine_model_run,
        .ai_forward = ai_sine_model_forward,
        .ai_data_params_get = ai_sine_model_data_params_get,

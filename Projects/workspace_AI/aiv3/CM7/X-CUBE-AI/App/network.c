...
#define AI_NETWORK_MODEL_SIGNATURE     "3b8ce54c1a2845a57ad45ed40af9fbe7"
...
#define AI_TOOLS_DATE_TIME   "Thu Jun 13 15:21:10 2024"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 794136, 1, 1),
    794136, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    conv2d_1_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 1080);
    conv2d_1_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 1080);
    
    conv2d_1_output_array.data = AI_PTR(g_network_activations_map[0] + 1080);
    conv2d_1_output_array.data_start = AI_PTR(g_network_activations_map[0] + 1080);
    
    max_pooling2d_1_output_array.data = AI_PTR(g_network_activations_map[0] + 1080);
    max_pooling2d_1_output_array.data_start = AI_PTR(g_network_activations_map[0] + 1080);
    ...
    dense_1_output_array.data = AI_PTR(g_network_activations_map[0] + 512);
    dense_1_output_array.data_start = AI_PTR(g_network_activations_map[0] + 512);
    ...
    dense_2_output_array.data = AI_PTR(g_network_activations_map[0] + 512);
    dense_2_output_array.data_start = AI_PTR(g_network_activations_map[0] + 512);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    dense_1_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 1536);
    dense_1_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 512);
    
    dense_1_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 722432);
    dense_1_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 722432);
    
    dense_2_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_2_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 722944);
    dense_2_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 722944);
    
    dense_2_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_2_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 788480);
    dense_2_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 788480);
    
    dense_3_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_3_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 788992);
    dense_3_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 788992);
    
    dense_3_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_3_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 792064);
    dense_3_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 792064);
    
    conv2d_1_conv2d_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_1_conv2d_weights_array.data = AI_PTR(g_network_weights_map[0] + 792088);
    conv2d_1_conv2d_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 792088);

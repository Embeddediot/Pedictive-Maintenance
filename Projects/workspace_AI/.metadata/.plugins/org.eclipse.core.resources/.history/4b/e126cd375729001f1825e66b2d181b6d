...
/* used only by Stellar-E MCUs, empty for all other MCUs */
#define port_io_init()
...
#if !defined(STM32F7) && !defined(STM32L4) && !defined(STM32L5) && !defined(STM32F4) && !defined(STM32H7)  && !defined(STM32H7RS) && !defined(STM32F3) && !defined(STM32U5) && !defined(STM32H5) && !defined(STM32G0) && !defined(STM32F0) && !defined(STM32C0)

...
#define AI_NETWORK_MODEL_SIGNATURE     "8d36b24bf775e695fefda23ad40eee47"
...
#define AI_TOOLS_DATE_TIME   "Thu Jun 20 12:42:02 2024"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  8, 0x0,
  AI_SHAPE_INIT(4, 20, 5, 1, 1), AI_STRIDE_INIT(4, 4, 80, 400, 400),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  10, 0x0,
  AI_SHAPE_INIT(4, 1, 1, 1, 9), AI_STRIDE_INIT(4, 4, 4, 4, 4),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  11, 0x0,
  AI_SHAPE_INIT(4, 1, 16, 1, 9), AI_STRIDE_INIT(4, 4, 4, 64, 64),
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &conv1d_output0),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &dense_dense_output),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 12148, 1, 1),
    12148, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 656, 1, 1),
    656, NULL, NULL),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    input_0_output_array.data = AI_PTR(g_network_activations_map[0] + 44);
    input_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 44);
    
    conv1d_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 80);
    conv1d_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 80);
    
    conv1d_output_array.data = AI_PTR(g_network_activations_map[0] + 80);
    conv1d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 80);
    ...
    dense_output_array.data = AI_PTR(g_network_activations_map[0] + 80);
    dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 80);
    ...
    dense_1_output_array.data = AI_PTR(g_network_activations_map[0] + 20);
    dense_1_output_array.data_start = AI_PTR(g_network_activations_map[0] + 20);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    conv1d_conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 64);
    conv1d_conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 64);
    
    dense_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 128);
    dense_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 128);
    
    dense_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 11648);
    dense_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 11648);
    
    dense_1_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 11728);
    dense_1_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 11728);
    
    dense_1_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 12128);
    dense_1_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 12128);

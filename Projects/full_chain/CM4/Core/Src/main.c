...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef* htim)
{
  if (htim->Instance == TIM5)  // Replace TIMx with your timer instance
  {
    ...
    if (sample_count == FRAME_SIZE) {
      ...
      memcpy((float *)overlap_buffer_x, (float *)&current_buffer_x[OVERLAP_SIZE], OVERLAP_SIZE * sizeof(float));
      memcpy((float *)overlap_buffer_y, (float *)&current_buffer_y[OVERLAP_SIZE], OVERLAP_SIZE * sizeof(float));
      memcpy((float *)overlap_buffer_z, (float *)&current_buffer_z[OVERLAP_SIZE], OVERLAP_SIZE * sizeof(float));
      ...
      memcpy((float *)current_buffer_x, overlap_buffer_x, OVERLAP_SIZE * sizeof(float));
      memcpy((float *)current_buffer_y, overlap_buffer_y, OVERLAP_SIZE * sizeof(float));
      memcpy((float *)current_buffer_z, overlap_buffer_z, OVERLAP_SIZE * sizeof(float));
